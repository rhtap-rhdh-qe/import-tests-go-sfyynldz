...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/import-tests-go-sfyynldz:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/import-tests-go-sfyynldz-gitops
